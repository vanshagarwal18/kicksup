  ...
  return (
    <div className="journeydiv">
      ...
      <ul className="experiences">
        <li>
          <h3 className="point">THE ROOTS</h3>
        ...
        <li>
          <h3 className="point">CHAPTER I</h3>
          <div className="point-description">
            ...
            building. After weeks of fruitful research, we stopped into the
        ...
        <li>
          <h3 className="point">CHAPTER II</h3>
          <div className="point-description">
            ...
            month. The experience was crucial to our brand as this is our first
            practical experience. Interacting with the users was the best thing
            over. The positive reviews and support from peple motivated us to
            push our limits further.
          </div>
        </li>
        <li>
          <h3 className="point">KICKSUP</h3>
          <div className="point-description">
            Here,we are made a perfect platform for you to involve in the making
            of a shoe you want to buy! We have evolved ever since we started
            out. We wish to help you more and make KICKSUP a bigger team. Design
            your shoe and be a part of our journey!
          </div>
        </li>
      </ul>
    </div>
